...
- 🤖 **AI 助手與模型註冊**： [NVIDIA NIM 微服務模型串接](./nvidia_nim/README.md) ｜ [OpenRouter 多模型聚合平台 (資安合規)](./openrouter/README.md) ｜ [n8n Chat Hub 企業級對話中心 (最新功能)](./chat_hub/README.md) ｜ [n8n MCP 協議設定 (Claude / OpenAI / Gemini)](./n8n_mcp/README.md) ｜ [Ollama 官方雲端模型整合](./ollama安裝/README.md)

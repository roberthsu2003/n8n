...
- **[初體驗](./初階範例/初體驗/README.md)**：手動觸發與基本資料傳遞
- **[JSON 基礎](./初階範例/json基礎/README.md)**：資料結構解析與表達式應用
- **[透過網站取得引言](./初階範例/透過網站取得隨機引言/README.md)**：HTTP Request API 整合與 AI 延伸
- **[CSV 轉換為 Excel](./初階範例/csv轉換為Excel/README.md)**：二進位檔案解析與格式轉換
- **[DataTable 簡單操作](./初階範例/DataTable/README.md)**：內建資料表、成績統計排名與 IF 條件判斷
- **[n8n 內建表單節點](./初階範例/表單節點/README.md)**：Form Trigger 表單設計與資料自動寫入

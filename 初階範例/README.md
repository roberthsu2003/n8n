...
### [⭐ 範例二：透過互動式逐步教程學習 JSON 基礎](./json基礎/README.md)
**難度**: 初級 | **學習時間**: 30-45 分鐘
...
### [⭐⭐ 範例三：透過網站取得引言](./透過網站取得隨機引言/README.md)
**難度**: 初級 | **學習時間**: 20-30 分鐘
...
### [⭐⭐ 範例四：CSV轉換為Excel](./csv轉換為Excel/README.md)
**難度**: 中級 | **學習時間**: 30-45 分鐘
...
1. **初體驗** → 建立對 n8n 的基本認識
2. **JSON 基礎** → 掌握資料格式的核心概念
3. **透過網站取得引言** → 學習 API 整合
4. **CSV轉換為Excel** → 進階檔案處理技巧

## 💡 學習建議

- **循序漸進**：每個範例都建立在前一個的基礎上，建議按順序學習
- **動手實作**：下載範例工作流程並實際執行，觀察每個節點的運作
- **嘗試修改**：理解範例後，嘗試修改參數或加入新功能
- **查看輸出**：點擊每個節點查看輸入/輸出資料，理解資料流向

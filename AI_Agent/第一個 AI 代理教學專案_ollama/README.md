# 第一個 AI 代理教學專案（使用 Ollama）

## 📚 學習目標

透過 Ollama 本地模型建立你的第一個 AI Agent，學習 AI 代理的基本架構和工具使用能力，無需雲端 API 金鑰即可開始實作。
...
這個範例展示如何使用 Ollama 本地 LLM 模型建立一個功能完整的 AI 代理，能夠：
- 接收並理解用戶的對話訊息
- 自主選擇合適的工具來回答問題
- 獲取即時天氣資訊
- 檢索最新新聞內容
...
```
📌 Sticky 1 (藍色): "試試看！啟動你的第一個 AI 代理"
📌 Sticky 2 (黃色): "稍後可以啟動此工作流程並分享公開聊天網址"
📌 Sticky 3 (黃色): "AI 代理的工作方式"
📌 Sticky 4 (黃色): "對話記憶的作用"
📌 Sticky 5 (黃色): "工具擴展說明"
```
...
1. 下載 `我的第1個AI_Agent_使用Ollama.json`
...
1. [範例一：智能客服聊天機器人](../智能客服聊天機器人/README.md)
   - 學習更完整的聊天機器人設計
   
2. [範例二：文件智能問答系統](../文件智能問答系統/README.md)
   - 學習 RAG 技術和向量資料庫
   
3. [範例三：具備工具使用能力的助理](../具備工具使用能力的助理/README.md)
   - 學習更多工具整合技巧
...
**🎓 完成此範例後，你將掌握 AI Agent 的基本概念，能夠使用 Ollama 建立本地化的智能助理！這是進入 AI Agent 世界的第一步，接下來可以探索更多進階功能和實際應用。**

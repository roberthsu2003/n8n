...
本階段聚焦於 **企業真實業務場景的深度落地**，包含私有文件向量知識庫（RAG）、跨系統子工作流調度（Call Workflow Tool）、郵件分類與工單閉環、以及多代理人（Multi-Agent Supervisor）團隊協同作業。
...
flowchart TD
    subgraph Enterprise_AI["企業級 AI 整合架構"]
        RAG["📚 RAG 向量知識庫<br/>(PDF/Word 切塊與檢索)"]
...
### 1. [範例 1：企業私有知識庫 RAG 智慧問答系統（文件向量檢索）](./RAG智能問答系統/README.md)
*徹底杜絕 AI 幻覺！將 PDF、Word 或試算表切塊、向量化並存入向量庫，精準依據知識庫作答。*
- **學習重點**：向量資料庫（In-Memory / PGVector）、Document Loader 切塊與 Embeddings 語意搜尋。
- **專案路徑**：[進入 RAG 智能問答系統完整專案](./RAG智能問答系統/README.md)

---

### 2. [範例 2：具備工作流呼叫能力的 AI 萬能助理（Call Workflow Tool）](./具備工具使用能力的助理/README.md)
...
### 3. [範例 3：Gmail 客服郵件智慧分類與自動歸檔系統](./郵件智能分類系統/README.md)
...
### 4. [範例 4：多代理人協作團隊（Multi-Agent Supervisor 經理與專家架構）](./多代理協作系統/README.md)
...
### 5. [範例 5：端到端客戶服務自動化平台（全渠道智慧分流與工單閉環）](./客戶服務自動化平台/README.md)
